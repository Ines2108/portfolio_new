    ...
    <>
      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className="pt-16">
          ...
          <section className="project-section mt-8 mb-24 w-full max-w-[1800px] mx-auto grid grid-cols-1 xs:grid-cols-2 xl:grid-cols-12 gap-24 xl:gap-">
            {projectsData.map((project, i) => {
              ...
              if (isFeatured) {
                return (
                  <div
                    key={project.slug}
                    className="col-span-1 xs:col-span-2 xl:col-span-12 mb-4 md:mb-8 lg:mb-0 flex justify-center">
