      ...
      <div className="flex flex-col items-center relative">
        ...
        <div className="block sm:hidden relative w-full">
          <div
            ...
            <div className="absolute top-[-25px] xs:top-[-15px] left-0 w-full h-full grid grid-cols-2 gap-2 px-6 pb-6 pt-14 place-items-center">
        ...
        <div className="hidden sm:block relative w-full md:w-3/4">
          <div
            ...
            <div className="absolute top-0 lg:top-[18px] left-0 w-full h-full max-h-[85%] grid grid-cols-3 gap-4 px-8 pt-20 place-items-center">
              {techSkills.map((skill, index) => (
                <motion.div
                  key={index}
